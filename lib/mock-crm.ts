  ...
  return {
    ...
    suggestions: [
      ...
      },
      {
        ...
        reason: 'OpenAI 企业版客户突破百万，Agent API 刚发布。距离上次联系 55 天，可以用 Agent 生态合作切入。',
        opener: 'Sam，恭喜 GPT-5 发布！我们基于 OpenAI API 做了一个 AI 关系管理的 Agent，早期数据不错。想了解 Agent API 的 partnership program 是否有机会合作。',
        created_at: daysAgo(2),
      },
      {
        id: 'suggestion-jensen-1',
        contact_id: 'contact-jensen',
        reason: 'NVIDIA Inception 计划对早期 AI 公司有资源支持，Cosmos 平台开放也意味着更多合作机会。距离上次联系 45 天。',
        opener: 'Jensen，上次 GTC 聊得很有收获。我们最近在 AI Agent 方向有些进展，想了解 Inception 计划是否能支持我们这类 AI 应用层公司，特别是在推理加速方面。',
      ...
      {
        id: 'suggestion-yiming-1',
        contact_id: 'contact-zhang-yiming',
        reason: '字节 Seed 团队刚发布新模型，TikTok 电商 GMV 暴涨。距离上次联系 90 天，可以用 AI 应用方向的交流重新建立联系。',
        opener: '一鸣，好久没联系了。看到 Seed 团队的 MoE 模型发布，技术路线很清晰。我最近在做的 AI 关系管理可能和字节的企业服务方向有交集，想找时间请教你对这个方向的判断。',
      ...
      {
        id: 'suggestion-ming-1',
        contact_id: 'contact-ming',
        reason: 'Orbit AI 种子轮刚关，首月 ARR 破百万，势头正好。可以聊产品合作或客户互推。',
        opener: '陈明，恭喜种子轮 close 和首月 ARR 破百万！我们产品方向有交集，想找时间聊聊有没有客户互推或功能集成的可能。',
        created_at: daysAgo(1),
      },
      {
        id: 'suggestion-sarah-1',
        contact_id: 'contact-sarah',
        reason: 'LatticeWorks 新推出的 AI 客户健康评分上了 PH #2，说明她在 AI 功能上有决策权和执行力。',
        opener: 'Sarah，看到你们 AI 客户健康评分上了 Product Hunt #2，恭喜！我们在 AI 关系管理上做的东西和你们客户成功方向有互补，想聊聊有没有集成的可能。',
        created_at: daysAgo(2),
      },
      {
      ...
      {
        id: 'suggestion-lei-1',
        contact_id: 'contact-lei',
        reason: '他刚发布 2026 企业软件投资报告，看好 AI 原生 ERP 和出海 SaaS。距离上次联系 61 天。',
        opener: '王磊，看了你们刚发的企业软件投资报告，对 AI 原生应用的判断很有洞察。我们的产品正好在这个方向上，想找时间和你详聊一下，也听听你对市场节奏的看法。',
        created_at: daysAgo(3),
      },
      {
        id: 'suggestion-david-1',
        contact_id: 'contact-david',
        reason: 'AI 私域试点数据非常好（复购+23%），Q3 预算周期将至，适合推动扩大合作。',
        opener: 'David，上次聊到的 AI 私域试点数据看起来相当好，复购率 23% 的提升非常实在。Q3 预算周期快到了，想提前聊聊扩大合作的方案，也带几个新的 use case 给你看。',
        created_at: daysAgo(2),
      },
    ],
    chats: [
      ...
      },
      {
        ...
        contact_id: 'contact-elon',
        role: 'assistant',
        content: 'xAI 融资后正在扩张生态，这是最好的切入窗口。建议不要直接聊投资，而是以"AI Agent 在 Grok 平台上的应用场景"为话题。Elon 喜欢简洁直接的沟通，一条推文长度的消息比长邮件有效。',
        created_at: daysAgo(3),
      },
      {
        id: 'chat-sam-1',
        contact_id: 'contact-sam',
        role: 'user',
        content: '我想了解 OpenAI 的 Agent API partnership，怎么切入比较好？',
        created_at: daysAgo(4),
      },
      {
        id: 'chat-sam-2',
        contact_id: 'contact-sam',
        role: 'assistant',
        content: '建议通过 YC 校友网络联系，用产品数据说话。重点突出：1) 你的产品已经在用 OpenAI API，2) 有真实用户和留存数据，3) 想探索 Agent API 的深度集成。Sam 最看重实际的产品 traction。',
        created_at: daysAgo(4),
      },
      {
        id: 'chat-anna-1',
      ...
      },
      {
        ...
        contact_id: 'contact-anna',
        role: 'assistant',
        content: '非常适合。她刚投了 AI Agent 赛道的 A 轮，说明正在积极部署这个方向。你可以用产品验证进展切入，强调留存数据而不是 GMV。建议先发一个低压力的请教型消息，不要直接进入融资话题。',
        created_at: daysAgo(2),
      },
      {
        id: 'chat-ming-1',
      ...
      },
      {
        ...
        contact_id: 'contact-ming',
        role: 'assistant',
        content: '很合适。融资完成后创始人通常心情好、视野开阔，愿意聊合作。而且他之前提过想找设计合伙人，你可以用"恭喜融资 + 产品合作探讨"的方式切入。',
        created_at: daysAgo(1),
      },
      {
        id: 'chat-jensen-1',
        contact_id: 'contact-jensen',
        role: 'user',
        content: '怎么跟 Jensen 聊 NVIDIA Inception 合作？',
      ...
      },
      {
        ...
        contact_id: 'contact-jensen',
        role: 'assistant',
        content: '不建议直接找 Jensen 本人聊 Inception，他太忙了。建议策略：1) 先通过 Inception 官方渠道申请，2) 然后用 GTC 认识的关系请 Jensen 的 EA 帮忙加速，3) 如果有机会见面，聊 AI Agent 在推理端的需求比聊申请本身更有效。',
        created_at: daysAgo(5),
      },
      {
        id: 'chat-lei-jun-1',
      ...
      },
      {
        ...
        contact_id: 'contact-lei-jun',
        role: 'assistant',
        content: '雷军日程非常满，建议不要直接约他，而是通过介绍你的那位生态链 VP 推进。具体路径：1) 先找 VP 聊清楚小米 AI 生态的合作标准，2) 准备一个 5 分钟的 demo 视频，3) 如果 VP 认可，他会帮你安排和雷军的短暂沟通。',
        created_at: daysAgo(4),
      },
      {
        id: 'chat-lei-1',
        contact_id: 'contact-lei',
        role: 'user',
        content: '王磊看好 AI 原生 ERP，我们产品算这个方向吗？',
        created_at: daysAgo(5),
      },
      {
        id: 'chat-lei-2',
        contact_id: 'contact-lei',
        role: 'assistant',
        content: '严格来说不算 ERP，但你的产品属于"AI 原生企业应用"这个更大的类别，王磊的报告里也提到了这一层。建议跟他聊时定位为"AI-native relationship management"，强调和传统 CRM 的代际差异，这比硬套 ERP 标签更有说服力。',
        created_at: daysAgo(5),
      },
    ],
    relationships: [
